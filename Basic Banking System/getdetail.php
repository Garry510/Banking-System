		...
		<table class="flat-table-1">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<form action="user.php" method="post" class="view">
							<button class="button1" type="submit" name="name" value="Yogesh">View</button>
						</form>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<form action="user.php" method="post" class="view">
							<button class="button1" type="submit" name="name" value="Tapendra">View</button>
						</form>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<form action="user.php" method="post" class="view">
							<button class="button1"type="submit" name="name" value="Nisha">View</button>
						</form>
					</td>
				</tr>
				<tr>
