<html>
	...
	<body >
		<div id="header">
			<br>
			<h1 style=" font-family:Agency FB; font-size: 70px; color:#00ff00;text-shadow: 2px 2px black;"> Welcome To The Spark Foundation Bank </h1>
			<h2 style=" font-family:Agency FB; font-size: 55px;color:#F7FE2E;text-shadow: 2px 2px black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Basic Banking System </h2>
		</div>
		<div id="section">
			<table>
			<tr></tr>
			...
			<tr>
				...
				<a href="About Us.html">
					<button class="primary_btn" id="button" type="button">About Us</button>
				</a>
			</tr>
		</table>
	</div>
